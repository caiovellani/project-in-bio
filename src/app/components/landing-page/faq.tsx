const faqItems = [
	...
	{
		title: "Posso personalizar o design do meu portflólio?",
		description:
			"Sim! Com Project in Bio, você pode personalizar cores, fontes e layout do seu portfólio, garantindo que ele reflita a sua marca pessoal.",
	},
	{
	...
	},
	{
		...
		description:
			"Você pode cancelar sua assinatura a qualquer momento. Seu portfólio e página de links ficarão disponíveis até o final do período pago, mas após isso, as funcionalidades serão desativadas.",
	},
];
